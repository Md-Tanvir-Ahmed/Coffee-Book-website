    ...
    return (
        <div className="my-12">
            ...
            <div className="flex justify-between items-center my-6">
                ...
                <div>
                    <button disabled={isFavorite} onClick={() => handleFavorite(coffee)} className="btn btn-warning">Add Favourite</button>
                </div>
            </div>
                ...
                <div className="flex-1">
                    <div className="flex flex-col justify-center gap-6">
                        ...
                        <ul className="text-xl ml-12">
                            {
                                ingredients && ingredients.map(i => <li className="list-disc" key={i}>{i}</li>)
                            }
                        ...
                        <ul className="text-xl ml-12">
                            {
                                nutrition_info && Object.keys(nutrition_info).map( n => <li className="list-dis" 
                                key={nutrition_info[n]}>
                                    {n} : {nutrition_info[n]}
                                </li>)
                            }
